...
class GTMService:
    ...
    def list_containers(self, account_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.service.accounts().containers().list(parent=account_path).execute()
            containers = []
    ...
    def list_workspaces(self, container_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().list(parent=container_path).execute()
            workspaces = []
    ...
    def list_tags(self, workspace_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().tags().list(parent=workspace_path).execute()
            tags = []
    ...
    def list_triggers(self, workspace_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().triggers().list(parent=workspace_path).execute()
            triggers = []
    ...
    def get_tag(self, workspace_path: str, tag_id: str) -> Dict[str, Any]:
        """Gets a specific tag."""
        try:
            response = self.service.accounts().containers().workspaces().tags().get(
    ...
    def create_workspace(self, container_path: str, name: str, description: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.service.accounts().containers().workspaces().create(
    ...
    def create_tag(self, workspace_path: str, tag_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().tags().create(
                parent=workspace_path, body=tag_data
            ).execute()
            return response
        except Exception as e:
    ...
    def create_trigger(self, workspace_path: str, trigger_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().triggers().create(
                parent=workspace_path, body=trigger_data
            ).execute()
            return response
        except Exception as e:
    ...
    def list_variables(self, workspace_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().variables().list(parent=workspace_path).execute()
            variables = []
    ...
    def list_built_in_variables(self, workspace_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().built_in_variables().list(parent=workspace_path).execute()
            return response.get('builtInVariable', [])
        except Exception as e:
            print(f"Error listing built-in variables for {workspace_path}: {e}")
            return []

    def enable_built_in_variable(self, workspace_path: str, variable_type: str) -> Dict[str, Any]:
        """Enables a built-in variable."""
        print(f"--- Enabling Built-In Variable: {variable_type} ---")
        try:
            response = self.service.accounts().containers().workspaces().built_in_variables().create(
                parent=workspace_path, type=variable_type
            ).execute()
            return response
        except Exception as e:
    ...
    def create_variable(self, workspace_path: str, variable_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().variables().create(
                parent=workspace_path, body=variable_data
            ).execute()
            return response
        except Exception as e:
    ...
    def update_tag(self, tag_path: str, tag_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = self.service.accounts().containers().workspaces().tags().update(
                path=tag_path, body=tag_data
            ).execute()
            return response
        except Exception as e:
        ...
        if accounts:
            ...
            if containers:
                ...
                if workspaces:
                    ...
                    print(f"Testing with workspace: {workspaces[0]['name']} ({ws_path})")

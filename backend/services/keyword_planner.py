...
class KeywordPlannerService:
    ...
    def generate_keyword_ideas(self, keywords=None, page_url=None, location_ids=None, language_id="1000", customer_id=None):
        """
        ...
        if not target_customer_id:
            raise ValueError("customer_id must be provided either in init (env var GOOGLE_ADS_CUSTOMER_ID) or as an argument.")
        ...
        if location_ids:
            for loc in location_ids:
                ...
                if found_resource:
                    ...
                    print(f"Warning: Could not find location '{loc}'. Defaulting to USA.")
    ...
    def get_forecast_metrics(self, keywords, location_id="Denmark", language_id="1000"):
        ...
        try:
            ...
            keyword_plan.forecast_period.date_interval = self.client.enums.KeywordPlanForecastIntervalEnum.NEXT_QUARTER
            ...
            if geo_resource:
                ...
                campaign.geo_targets.append({"geo_target_constant": "geoTargetConstants/2840"}) # Default US
    ...
    def get_historical_metrics(self, keywords, location_id="Denmark", language_id="1000"):
        """
        ...
        try:
            ...
            request.geo_target_constants.append(self._lookup_location_id(location_id) or "geoTargetConstants/2840")
            request.keyword_plan_network = self.client.enums.KeywordPlanNetworkEnum.GOOGLE_SEARCH
            request.language = f"languageConstants/{language_id}"
